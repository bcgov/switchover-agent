...
config = dict(
    ...
    pipeline_retry_interval_seconds=_int_env("PIPELINE_RETRY_INTERVAL_SECONDS", 30),
    ...
    pipeline_attempt_timeout_seconds=_int_env("PIPELINE_ATTEMPT_TIMEOUT_SECONDS", 360),
)
